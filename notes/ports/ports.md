...
⚠️ Самые опасные/атакуемые (по данным Shodan):
22 (SSH) — брутфорс, подбор паролей
23 (Telnet) — полное отсутствие шифрования
80 (HTTP) — перехват трафика, XSS, SQLi
443 (HTTPS) — уязвимости SSL/TLS
445 (SMB) — WannaCry и другие шифровальщики
3389 (RDP) — брутфорс, BlueKeep
3306/5432 (MySQL/PostgreSQL) — утечки данных
